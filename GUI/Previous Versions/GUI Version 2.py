...
def main():
    ...
    font_title = try_font(['Bahnschrift'], 22)
    font_body  = try_font(['Bahnschrift'], 17)
    font_sm    = try_font(['Bahnschrift'], 14)
    font_pred  = try_font(['Bahnschrift'], 26)
    font_conf  = try_font(['Bahnschrift'], 18)
    ...
    eraser_slider = Slider(RIGHT_X + 20, set_y + 122, RIGHT_PANEL_W - 40, 1, 40, 10, 'Eraser Size')
